                ...
                <form action=" {{ route('orders.store')}}" method="POST">
                    ...
                    <div class="mb-4 flex items-end ">
                        ...
                        <div class="mr-4 ">
                            ...
                            <input type="number" id="installments" name="installments"  class="disabled:opacity-75 form-input mt-1 block rounded disabled:bg-slate-50" disabled placeholder="Digite a Quantidade">
...
function addItemToSoldItems(productId, quantity) {
    ...
    updateSoldItemsInput(); // Atualiza o input escondido
}

// Atualiza o input escondido com os produtos vendidos
...
// Ao adicionar um novo item à lista de itens vendidos
function addNewItem(productId, quantity) {
    const newItemHTML = `
        <input type="hidden" id="soldItems" name="sold_items[]" value="${productId},${quantity}">
    `;
    document.querySelector('#items-list').innerHTML += newItemHTML;
    ...
    addItemToSoldItems(productId, quantity);
        ...
        $('form').submit(function() {
         ...
         $(document).ready(function() {
            ...
            function addInstallmentsInputs(numInstallments) {
                ...
                // Limpa qualquer input de parcelas existente
                ...
                // Calcula o mês atual e o ano atual
                var currentMonth = today.getMonth() + 1;
                var currentYear = today.getFullYear();

                // Calcula o mês e o ano da parcela
                ...
                // Adiciona inputs de parcelas e datas editáveis
        ...
        //Pega o valor do produto e atualiza o subtotal no final
        $('#product').change(function() {
        ...
        $('#quantity').change(function() {
            // Atualiza o subtotal ao mudar a quantidade
            updateSubtotal();
        });
