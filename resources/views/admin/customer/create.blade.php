    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <h3 class="text-lg font-semibold mb-4">Preencha os dados do Cliente abaixo:</h3>
                <form action=" {{ route('customers.store')}}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="nome" name="name" class="form-input mt-1 block w-full" placeholder="Digite o nome do cliente">
                    </div>
                    
                    <div class="mb-4">
                        <label for="cpf" class="block text-gray-700 font-semibold">CPF:</label>
                        <input type="text" id="cpf" name="cpf" class="form-input mt-1 block w-full" placeholder="Digite o CPF do cliente">
                    </div>
