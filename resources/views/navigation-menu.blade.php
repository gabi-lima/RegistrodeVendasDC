        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('orders.show', Auth::user()->id) }}" :active="request()->routeIs('orders.show')">
                        {{ __('Ver Vendas') }}
                    </x-nav-link>
                    ...
                    <x-nav-link href="{{ route('products.show', Auth::user()->id) }}" :active="request()->routeIs('products.show')">
                        {{ __('Ver Produtos') }}
                    </x-nav-link>
